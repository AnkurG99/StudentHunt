...
val latest = FirebaseDatabase.getInstance().getReference("/latest_messages/$fromID/$toID")
latest.setValue(chat)
        val latestto = FirebaseDatabase.getInstance().getReference("/latest_messages/$toID/$fromID")
