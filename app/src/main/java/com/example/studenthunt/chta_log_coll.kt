...
class chta_log_coll : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_chta_log_coll)
        ...
        name_user.setOnClickListener {
            val intent =  Intent(this, stu_profile::class.java)
    ...
    private fun listenformsg(){
        ...
        val toID = uid
        val refmsg = FirebaseDatabase.getInstance().getReference("/messages_coll/$fromID/$toID")
   ...
   */
        ...
        if(fromID == null)
            return
        val refff = FirebaseDatabase.getInstance().getReference("/messages_coll/$fromID/$toID").push()
        val reffto = FirebaseDatabase.getInstance().getReference("/messages_coll/$toID/$fromID").push()
        ...
        val latest = FirebaseDatabase.getInstance().getReference("/latest_messages_coll/$fromID/$toID")
        latest.setValue(chat)
        val latestto = FirebaseDatabase.getInstance().getReference("/latest_messages_coll/$toID/$fromID")
